...
![CI](https://github.com/jacob-palathingal/pr-complexity-analyzer/actions/workflows/ci.yml/badge.svg)
...
└── internal/
    ...
    ├── analyzers/
    │   └── python/   Radon-backed cyclomatic complexity
...
See [docs/extending-analyzers.md](docs/extending-analyzers.md).
